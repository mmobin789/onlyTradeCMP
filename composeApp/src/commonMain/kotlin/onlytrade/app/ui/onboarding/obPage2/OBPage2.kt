package onlytrade.app.ui.onboarding.obPage2
...
import onlytrade.app.ui.onboarding.obPage2.colorScheme.ob2ColorScheme
...
fun OBPage2(onNextClick: () -> Unit) {
    Scaffold(topBar = {
        Row(
            modifier = Modifier.background(ob2ColorScheme.topBarBG)
                .padding(16.dp)
                .background(
                    color = ob2ColorScheme.obLogoBar, shape = MaterialTheme.shapes.large
                )
                .fillMaxWidth()
                .padding(24.dp),
        ...
        Box(
            Modifier
                ...
                .fillMaxSize()
                .background(ob2ColorScheme.screenBG)
        ) {
            Column(
                modifier = Modifier
